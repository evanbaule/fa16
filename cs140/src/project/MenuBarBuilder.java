...
public class MenuBarBuilder implements Observer{
	...
	public JMenu createFileMenu(){
		...
		load.addActionListener(e -> view.loadFile()); //Again where tf does this method come from
		menu.add(load);
	...
	public JMenu createJobsMenu(){ // this is wrong
